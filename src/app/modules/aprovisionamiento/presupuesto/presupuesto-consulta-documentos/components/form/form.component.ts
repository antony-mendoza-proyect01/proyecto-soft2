...
export class FormComponent implements OnInit {
  ...
  @Output() searchConsulta = new EventEmitter<ConsultaTareasPresupuesto>();
  ...
  onSubmit() {
    ...
    const body = new ConsultaTareasPresupuesto(value.tarea, value.idCiudad, value.idCambio, Number(value.idEstado) );

    this.searchConsulta.emit(body);
  }
